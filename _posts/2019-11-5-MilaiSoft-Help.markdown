...
pagetag: milaisoft-maple
img: blackmaple.jpg 
fig-caption: 
tags: [韩服, 冒险岛, Naver, 登录器]
---

![左上角更多]({{site.baseurl}}/assets/img/milaisoft-maple/maplestory.png)
...
2. 一次性登陆码目录如图：
![左上角更多]({{site.baseurl}}/assets/img/milaisoft-maple/1.png){:width="250" }
![右上角设置]({{site.baseurl}}/assets/img/milaisoft-maple/2.jpg){:width="250" }
![Naver账号]({{site.baseurl}}/assets/img/milaisoft-maple/3.jpg){:width="250" }
![收取一次性登录号码]({{site.baseurl}}/assets/img/milaisoft-maple/4.jpg){:width="250" }
![8位数号码]({{site.baseurl}}/assets/img/milaisoft-maple/5.jpg){:width="250" }

3. 启动配置；

![ ]({{site.baseurl}}/assets/img/milaisoft-maple/6.png){:width="250" }
...
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/7.png){:width="250" }
...
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/8.png){:width="250" }
...
### 2. 请填写冒险岛路径或者LE路径
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/9.png){:width="250" }
...
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/10.gif){:width="250" }
...
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/11.png){:width="250" }
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/12.png){:width="250" }
...
### 6.	无法进入游戏，弹出框框
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/13.png){:width="250" }

> 进入游戏提示无法进入游戏，重新点击一下登录，获取一下游戏最新登录信息，也无需输入OTP码。如图：提示为，当前在官网已经登出，直接点一下登录就可以了。


### 7. Naver 登录失败
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/14.png){:width="250" }
...
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/15.png){:width="250" }
...
![ ]({{site.baseurl}}/assets/img/milaisoft-maple/16.png){:width="250" }
